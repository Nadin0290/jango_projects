...
SECRET_KEY = 'django-insecure-#4h$inf#zsahidoe_#@l57^21cj)ijzu-c9d$t+%%7tjm(i7jt'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1','http://127.0.0.1:8000/accounts/google/login/callback/','localhost']
...
LOGIN_REDIRECT_URL = "/sign/signup/" # адрес перенаправления после успешного входа.
...
INSTALLED_APPS = [
    ...
    'django_filters',
     ...
     # для аутентификации, идентификации, авторизации
...
MIDDLEWARE = [
    ...
    'NewsApp.middlewares.TimezoneMiddleware', # add that middleware!
]
